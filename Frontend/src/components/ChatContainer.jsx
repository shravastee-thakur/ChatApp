...
const ChatContainer = ({ selectedUser, setSelectedUser }) => {
  ...
  return selectedUser ? (
          ...
          return (
            ...
            >
              {msg.image ? (
                ...
                <p
                  className={`p-2 max-w-[200px] md:text-sm font-light rounded-lg mb-6 break-all bg-[#046a7a] text-white ${
                    msg.senderId === "680f50e4f10f3cd28382ecf9"
                      ? "rounded-br-none"
                      : "rounded-bl-none"
                  }`}
    ...
    <div className="flex flex-col gap-4 justify-center items-center max-md:hidden">
      ...
      <p className="text-sm font-medium text-white">Chat anytime, anywhere</p>
    </div>
  );
};
